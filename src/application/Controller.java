...
public class Controller implements Initializable {
    ...
    private String[] choiceBox2Strings = { "avocado", "ball", "banana", "beer", "cat", "coke", "doll", "dragon",
            "dragonfruit", "drum", "egg", "game", "glasses",
            "goat", "hat", "noodles", "potato", "sandwich", "sausage", "seal", "shirt", "shorts", "tea", "water" };
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (firstPlace != null )
            gameLogic.winner(score1, score2, score3, score4, firstPlace, secondPlace, thirdPlace);
        }

    // method to get number of player
    ...
    // method to roll the dice with animation, animate the lids
    ...
    // method to get the position of the picture
    ...
    // method to add score, move to next player
